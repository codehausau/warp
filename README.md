...
WARP now includes GitHub-native security automation for dependency updates, dependency review, and CodeQL scanning. Operational guidance for maintainers is documented in [SECURITY.md](SECURITY.md).
